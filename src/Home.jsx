...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // allow image swap to apply before toggling opacity
  ...
  return (
    <>
      <style>{`
        ...
        /* ~10x larger vs typical 64px: make responsive */
        ...
        .card{ display:grid; grid-template-columns: 320px 1fr; gap:18px; background:#0c122ce6; border:1px solid #ffffff22; border-radius:16px; overflow:hidden; margin:18px 0; box-shadow:0 10px 40px #0008; }
      ...
      <div className="page">
        ...
        <header className="header">
          <div className="brand">
            <img className="logo float" src={logo} alt="Storm Lead Machine logo" />
            <div>
        ...
        <main className="main">
          ...
          {active === "lead-types" && (
            <section className="panel reveal">
              ...
              <div className="card reveal">
                <img className="img float" src={hailImg} alt="Hail damage" />
                <div className="body">
                  <h3>Hail</h3>
              ...
              <div className="card reveal">
                <img className="img float" src={windImg} alt="Wind damage" />
                <div className="body">
                  <h3>Wind</h3>
              ...
              <div className="card reveal">
                <img className="img float" src={tornadoImg} alt="Tornado / hurricane damage" />
                <div className="body">
          ...
          {active === "pricing" && (
            <section className="panel reveal">
              ...
              {/* Trial on top */}
              <div className="trial reveal float">
